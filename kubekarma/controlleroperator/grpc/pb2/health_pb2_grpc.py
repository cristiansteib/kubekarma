...
from kubekarma.controlleroperator.grpc.pb2 import health_pb2 as kubekarma_dot_controlleroperator_dot_grpc_dot_pb2_dot_health__pb2
...
def add_HealthServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Check': grpc.unary_unary_rpc_method_handler(
                    servicer.Check,
                    request_deserializer=kubekarma_dot_controlleroperator_dot_grpc_dot_pb2_dot_health__pb2.HealthCheckRequest.FromString,
                    response_serializer=kubekarma_dot_controlleroperator_dot_grpc_dot_pb2_dot_health__pb2.HealthCheckResponse.SerializeToString,
            ),
